    ...
    <AnimatePresence>
      {isOpen && (
        <>
          ...
          >
            <div className="h-full bg-card rounded-3xl overflow-hidden flex flex-col border border-border shadow-2xl">
              {/* Header */}
              <div className="relative p-6 md:p-8 border-b border-border/50">
                ...
                <div className="flex items-start gap-6">
                  <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-primary/15 to-accent/10 flex items-center justify-center">
