    ...
    >
      <header className="w-full h-full px-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          <button
            onClick={onMenuClick}
            className="lg:hidden p-2 hover:bg-gray-100 rounded-xl transition-all duration-150"
          >
          ...
          <Link
            to="/"
            className="hidden sm:flex text-[11px] font-medium text-gray-400 hover:text-gray-600 transition-colors ml-2"
          >
            ← Store
          </Link>
        </div>
        ...
        <div className="hidden md:flex flex-1 max-w-md mx-8">
          <div className="relative w-full group">
            ...
            <input
              type="text"
              placeholder="Search..."
              className="w-full pl-10 pr-14 py-2 bg-gray-100 rounded-xl text-[13px]
        ...
        <div className="flex items-center gap-2">
          <button className="flex items-center gap-1.5 px-4 py-2 bg-gray-900 hover:bg-gray-800 text-white rounded-xl transition-all duration-150 text-[13px] font-medium active:scale-[0.97]">
