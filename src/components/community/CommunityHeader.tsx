    ...
    >
      <header className="w-full h-full px-5 flex items-center justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link to="/community" className="flex items-center gap-2.5 cursor-pointer">
        ...
        <div className="flex items-center gap-1.5">
          <button className="flex items-center gap-1.5 px-3.5 py-[7px] bg-gray-900 hover:bg-gray-800 text-white rounded-lg transition-all duration-150 text-[13px] font-medium shadow-sm shadow-gray-900/10 active:scale-[0.97]">
